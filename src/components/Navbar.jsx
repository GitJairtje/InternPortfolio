...
const Navbar = () => {
  ...
  return (
   ...
   >
    ...
    <p className="text-white text-[18px] font-bold cursor-pointer flex">Jaïr Pietersz &nbsp;
    <span className="sm:block hidden"> | Front End Developer
    </span></p>
    </Link>
     <ul className="list-none hidden sm:flex flex-row gap-10">
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        top-20 right-0 mx-4 my-2 min-4-[140px] z-10 rounded x1`}>
